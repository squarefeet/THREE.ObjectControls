...
THREE.ObjectControlsPhysijs = function(options) {
    ...
    var
        ...
        rollAcceleration = options.rollAcceleration || 2,
    ...
    targetObject.setDamping( 0.2, 0.8 );

    var updatePositionPhysijs = function( dt ) {
        // if( forward ) {
            // targetObject.applyCentralForce( new THREE.Vector3( 0, 0, -1000000 ) );
        // }

        // targetObject.setLinearVelocity( positionVector );

        targetObject.applyCentralForce( positionVector );

        if( rollLeft ) {
            // targetObject.applyImpulse( new THREE.Vector3( 0, -1000, 0 ), new THREE.Vector3( -25, 0, 0 ) );
            // targetObject.applyImpulse( new THREE.Vector3( 0, 1000, 0 ), new THREE.Vector3( 25, 0, 0 ) );
            targetObject.setAngularVelocity( new THREE.Vector3( 0, 0, 2 ) );
        }
